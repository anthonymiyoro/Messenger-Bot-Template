...
def determine_turn(turn, j, total_sum, reward, prev_total_sum, observation_n, reward_n):
...
def main():
    ...
    while True:
        ...
        if (observation_n[0] != None):
            turn, j, total_sum, prev_total_sum = determine_turn(turn, j, total_sum, reward_n[0], prev_total_sum,
                                                                observation_n[0])
